...
public class LoginView extends BorderPane implements Observer {
        ...
        public LoginView(FileManager man, Observer textView){
...
/// have confirm to load last game
           ...
           Optional<ButtonType> result = alert.showAndWait();
             if (result.get() == ButtonType.OK){
               ...
               // change game to userGame
System.out.println("Set Pokemon previous"); 


               theGame=temp.getPokemon();
...
System.out.println("Set Pokemon current for return"); 



               temp.setPokemon(theGame);
               man.pushUserData();
...
System.out.println("Set Pokemon current for new"); 
                   ...
                   //get user and set Pokemon to theGame
                    man.getUser(acctT.getText(),pswdT.getText()).setPokemon(theGame);
                    man.pushUserData();
