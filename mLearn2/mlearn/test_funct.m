function [the1,the2,the3] = test_funct(thetaVec,X,y)
...
the1 = the1 - (1/n)*(bd1 + lam*the1); the2 = the2 - (1/n)*(bd2 + lam*the2); the3 = the3 - (1/n)*(bd3 + lam*the3);  bd1=zeros(6,27); bd2= zeros(6,7); bd3=zeros(1,7); 
